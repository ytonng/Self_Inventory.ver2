...
public class UpFridge extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_up_fridge, container, false);

        // Set OnClickListener for each ImageButton
        view.findViewById(R.id.item1_button).setOnClickListener(v -> openDetailFragment("upItem 1"));
    ...
    private void openDetailFragment(String itemName) {
        ...
        UpFridgeDetail detailFragment = new UpFridgeDetail();
